...
<div class="card-body p-4" id="contenedoridioma">

    <form action="<?php echo getUrl("Usuario","Ofertas","AgregarIdioma");?>" class="col-md-12 justify-content-start"
        ...
        <div id="copy">
            <div class="eo row justify-content-start">
                ...
                <div class="titulos_negrita col-md-4">
                    Idioma/s*
                    <input type="text" name="idioma" id="idioma" placeholder="Ejm: ingles, aleman etc."
                        class="form form-control">
                </div>
                <div class="titulos_negrita col-md-4">
                    Nivel del idioma* <br>
                    <select type="text" name="NivelIdioma" id="NivelIdioma" placeholder="Ejm: ingles, aleman etc."
                        class="form form-control">
